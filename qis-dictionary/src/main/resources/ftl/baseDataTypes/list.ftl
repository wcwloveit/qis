        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-dark sbold uppercase">类型列表</span>
                </div>
                <div class="actions">
                    <div class="btn-group">
                        <div class="fileinput fileinput-new" data-provides="fileinput">
                            <a class="btn green btn-parent" href="${rc.contextPath}/baseDataTypes/create"> <#--跳转新增的URL-->
            ...
            <div class="portlet-body">
                ...
                <div class="table-container">
                    ...
                    <div id="data_table_search">
                        ...
                        <label style="float:left;margin-right:5px;">
                            <b class="form-control input-inline" style="border: 0px; text-align: left;">值</b>
                            <input type="text" class="input-sm form-filter" name="search_type_value"
                                   id="search_type_value" placeholder="值"/>
                        </label>
                        <label style="float:left;margin-right:5px;">
    ...
    <script type="text/javascript">
        ...
        grid.init({
            ...
            dataTable: {
                ...
                "iDisplayLength": 10,
                "bServerSide": true,
                "sAjaxSource": "${rc.contextPath}/baseDataTypes/list",
                "aaSorting": [
                    [ 0, "desc" ]
                ],
                "aoColumnDefs": [
                ...
                "aoColumns": [
                    ...
                    { "sTitle": "操作", "sDefaultContent": "", "mRender": function (data, type, row) {
                            var a = '<a href="${rc.contextPath}/baseDataTypes/update/' + row.id + '" class="btn btn-xs blue"  title="编辑" >' +
                                    '<i class="glyphicon glyphicon-pencil"></i>编辑</a>';
                            var b = '<a href="${rc.contextPath}/baseData/index/' + row.id + '" class="btn btn-xs green"  title="编辑" >' +
                ...
                buttons: {
                    main: {
                        ...
                        callback: function () {
                            ...
                            $.ajax({
                                url: '${rc.contextPath}/baseDateTypes/deleteOne-' + id,
                                type: 'POST',
                                traditional: true,
                ...
                buttons: {
                    main: {
                        ...
                        callback: function() {
                            Metronic.startPageLoading();
                            $.ajax({
                                url:'${rc.contextPath}/baseDataTypes/delete-all',
                                type:'POST',
                                data:{"ids":ids},
                                dataType:"json",
                                traditional:true,
