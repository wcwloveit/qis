<%@ page import="com.coracle.xsimple.api.common.Resource" %>
<%@ page import="com.coracle.xsimple.service.system.ResourceService" %>
<%@ page import="com.coracle.xsimple.util.Users" %>
