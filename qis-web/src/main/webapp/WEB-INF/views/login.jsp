...
<div class="logo">
    <a href="${ctx}/">
        <img src="${ctx}/assets/admin/layout/img/logo-big.png" alt="" style="position: relative;left: -98px;top: 9px;height: 35px;"/>
    </a>
</div>
...
<div class="content">
    <form class="login-form" action="${ctx}/login" method="post">
        ...
        <div class="form-group">
            <div>
                    <%--<a href="http://test.coracle.com:10082/mxm/download/IM.zip" download="PC端KIM" style="float:right;color:#eee;">下载PC端KIM</a>--%>
                        <a href="/mxm/download/IM.zip" style="float:right;color:#eee;">下载PC端KIM</a>
            </div>
        </div>
    </form>
</div>
<div class="copyright">@2017 &copy; 江苏新日电动车股份有限公司.</div>
<!--[if lt IE 9]>
