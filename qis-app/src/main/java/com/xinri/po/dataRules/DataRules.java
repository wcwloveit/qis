package com.xinri.po.dataRules;
...
public class DataRules extends DataEntity<DataRules>{
	...
	public String getFieldValueShow() {
		return fieldValueShow;
	}
	
    	public void setFieldValueShow(String fieldValueShow) {
		this.fieldValueShow = fieldValueShow;
	}
