...
/**
 * <p></p>
 * 类名:RoleModuleInfoColumnDataHeadspo<br>
 * 创建人:xiashanyong<br>
 * 创建时间:20180813<br>
 */
 
public class RoleModuleInfoColumnDataHeads extends DataEntity<RoleModuleInfoColumnDataHeads>{
    	...
    	private Long moduleInfoColumnDataId;
	...
	public Long getModuleInfoColumnDataId() {
		return moduleInfoColumnDataId;
	}
	
    	public void setModuleInfoColumnDataId(Long moduleInfoColumnDataId) {
		this.moduleInfoColumnDataId = moduleInfoColumnDataId;
	}
 ...
 public String getStartCreatedOn(){
    ...
    public String toString() {
		...
		sb.append("moduleInfoColumnDataId=");
		sb.append(moduleInfoColumnDataId);
		sb.append(",");   
