...
import com.qis.common.util.CookieUtils;
import com.qis.common.web.StatusMsgUtils;
import com.qis.common.web.StatusMsgUtils.ResponseCode;
...
public class Page implements Serializable{
	...
	private static final long serialVersionUID = 7130580294187123202L;
...
//	private int pageSize =30;
	...
	private String queryType;//单独处理查询总页数

	/*
	 sql  不为空的时候  拼接查询总数数  sql+  原sql的最后一个where 后的语句
	 */
	private String totalSql;// 查询sql
	 ...
	 * @param list 本页数据对象列表
	 */
	public Page(int pageNo, int pageSize, long totalSize, List list) {
	...
	public String toString() {
		...
		sb.append("共 " + totalSize + " 条"+(message!=null?message:"")+"</a></li>\n");
...
//		sb.insert(0,"<div class=\"page\">\n").append("</div>\n");
	...
	public String getMsg(){
		return ResponseCode.getName(StatusMsgUtils.SUCCEEDEDCODE_200);
	}
