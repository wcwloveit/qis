...
import com.qis.common.persistence.dialact.Dialect;
        ...
        if (parameterMappings != null) {
            ...
            for (int i = 0; i < parameterMappings.size(); i++) {
                ...
                if (parameterMapping.getMode() != ParameterMode.OUT) {
                    ...
                    JdbcType type=parameterMapping.getJdbcType();
                    if(type==null){
                    ...
                    typeHandler.setParameter(ps, i + 1, value, type);
