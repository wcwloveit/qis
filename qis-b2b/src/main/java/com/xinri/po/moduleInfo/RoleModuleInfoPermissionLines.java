...
/**
 * <p></p>
 * 类名:RoleModuleInfoPermissionLinespo<br>
 * 创建人:xiashanyong<br>
 * 创建时间:20180813<br>
 */
 
public class RoleModuleInfoPermissionLines extends DataEntity<RoleModuleInfoPermissionLines>{
    	...
    	private Long roleModuleInfoPermissionHeadId;
	/**
	 * createdOn字段查询条件开始
	 */
	...
	public Long getRoleModuleInfoPermissionHeadId() {
		return roleModuleInfoPermissionHeadId;
	}
	
    	public void setRoleModuleInfoPermissionHeadId(Long roleModuleInfoPermissionHeadId) {
		this.roleModuleInfoPermissionHeadId = roleModuleInfoPermissionHeadId;
	}
 ...
 public String getStartCreatedOn(){
    ...
    public String toString() {
		...
		sb.append("roleModuleInfoPermissionHeadId=");
		sb.append(roleModuleInfoPermissionHeadId);
		sb.append("]");
