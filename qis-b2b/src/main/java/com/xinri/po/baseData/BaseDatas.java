...
public class BaseDatas extends DataEntity<BaseDatas>{
	...
	public Long getBaseDataTypeId() {
    	...
    	public void setBaseDataTypeId(Long baseDataTypeId) {
		this.baseDataTypeId = baseDataTypeId;
	}
    
  
	public Long getParentBaseDataId() {
		return parentBaseDataId;
	}
	
    	public void setParentBaseDataId(Long parentBaseDataId) {
 ...
 public String getStartCreatedOn(){
    ...
    public String toString() {
		...
		sb.append("baseDataTypeId=");
		sb.append(baseDataTypeId);
		sb.append(",");   
		
		sb.append("parentBaseDataId=");
		sb.append(parentBaseDataId);
		sb.append(",");   
