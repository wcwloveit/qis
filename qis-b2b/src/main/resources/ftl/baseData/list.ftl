    ...
    <div class="col-md-12">
        <div class="portlet box green-haze">
            <div class="portlet-title">
                <div class="caption"><i class="fa fa-cogs"></i>考核产品列表</div>
                <div class="actions">
                    <div class="btn-group">
                        <div class="fileinput fileinput-new" data-provides="fileinput">

                            <a class="btn green btn-parent" href="${rc.contextPath}/zc/kaohe/updateJump"> <#--跳转新增的URL-->
                ...
                <div class="table-container">
                    ...
                    <div id="data_table_search">
                        ...
                        <label style="float:left;margin-right:5px;">
                            ...
                            <input type="text" class="input-sm form-filter" name="search_BaseData_name"
                                   id="search_BaseData_name" placeholder="名称"/>
                        </label>

                        <label style="float:left;margin-right:5px;">
                            <b class="form-control input-inline" style="border: 0px; text-align: left;">编号</b>
                            <input type="text" class="input-sm form-filter" name="search_BaseData_code"
                                   id="search_BaseData_code" placeholder="编号"/>
                        </label>

                    <#--<label style="float:left;margin-right:5px;">-->
                    <#--<b class="form-control input-inline" style="border: 0px; text-align: left;">数量</b>-->
                    <#--<input type="text" class="input-sm form-filter" name="search_ZC_orgNum"-->
                    <#--id="search_ZC_orgNum" placeholder="数量"/>-->
                    <#--</label>-->

                        <label style="float:left;margin-right:5px;">
                            <b class="form-control input-inline" style="border: 0px; text-align: left;">数据字典类型id</b>
                            <input type="text" class="input-sm form-filter" name="search_BaseData_baseDataTypeId"
                                   id="search_BaseData_baseDataTypeId" placeholder="数据字典类型id"/>
                        </label>
    ...
    <script type="text/javascript">
        ...
        grid.init({
            ...
            dataTable: {
                ...
                "iDisplayLength": 10,
                "bServerSide": true,
                "sAjaxSource": "${rc.contextPath}/BaseData/list",
                "aaSorting": [
                    [0, "desc"]
                ],
                "aoColumnDefs": [
                    {"bSortable": false, "aTargets": [0, 1, 2, 3, 4,5,6,7,8]}   //控制表格有多少列
                ],//设置不排序得列
...
//                    },
                    {
                        ...
                        var a = '<a href="${rc.contextPath}/zc/kaohe/update/' + row.id
                ...
                buttons: {
                    main: {
                        ...
                        callback: function () {
                            ...
                            $.ajax({
                                url: '${rc.contextPath}/zc/kaohe/deleteOne-' + id,
                                type: 'POST',
                                traditional: true,
                ...
                buttons: {
                    main: {
                        ...
                        callback: function() {
                            Metronic.startPageLoading();
                            $.ajax({
                                url:'${rc.contextPath}/zc/kaohe/deleteAll',
                                type:'POST',
                                data:{"ids":ids},
                                dataType:"json",
                                traditional:true,
