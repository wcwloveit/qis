...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${rc.contextPath}/assets/global/css/imgFile.css"/>
                ...
                <form id="myForm" action="${rc.contextPath}/role/${action?if_exists}"
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="desc" id="desc" value="${role.desc?if_exists}"/>
                            </div>
                        </div>
...
<content tag="script">
    ...
    <script src="${rc.contextPath}/assets/global/plugins/bootstrap-datepicker/js/locales/bootstrap-datepicker.zh-CN.js"
