...
<div class="row">
    <div class="col-md-12">
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="javascript:void(0);">颜色列表</a>
                <i class="fa fa-angle-right"></i>
            </li>
        </ul>
    </div>
    ...
    <div class="col-md-12">
        <div class="portlet box green-haze">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-gift"></i>产品：${(product.modelName)!}  配置：${(mode.bname)!}  颜色<#if action?? && action == 'create'>新增</#if><#if action?? && action == 'update'>编辑</#if>
                </div>
                 <div class="actions">
            ...
            <div class="portlet-body form">
                <form id="myForm" action="${rc.contextPath}/itemColor/${action}-${(product.id)?if_exists}-${(mode.id)?if_exists}" class="form-horizontal" method="POST">
                    <div class="form-body">
                        <#--<h3 class="form-section">基本信息</h3>-->
                        <input type="hidden" class="form-control"  name="id" value="${color.id?if_exists}" >
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-md-2 control-label" style="width: 87px;text-align: left;padding-right: 0">颜色料号<span class="required">
											 *
										</span></label>
                                    <div class="col-md-10">
                                        <input type="text" required="true" class="form-control" value="${color.colorCode?if_exists}"
                                               name="colorCode" placeholder="颜色料号" id="colorCode" >
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" required="true" class="form-control" value="${color.colorName?if_exists}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" required="true" class="form-control" value="${color.orgCode?if_exists}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" required="true" class="form-control" value="${color.price?if_exists}"
